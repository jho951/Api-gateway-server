...
```gradle
implementation platform("io.github.jho951.platform.packages:platform-runtime-bom:4.0.0")
implementation platform("io.github.jho951.platform.packages:platform-governance-bom:4.0.0")
implementation platform("io.github.jho951.platform.packages:platform-security-bom:4.0.0")
implementation "io.github.jho951.platform.packages:platform-governance-starter"
implementation "io.github.jho951.platform.packages:platform-security-starter"
implementation "io.github.jho951.platform.packages:platform-security-hybrid-web-adapter"
implementation "io.github.jho951.platform.packages:platform-security-governance-bridge:4.0.0"
```
