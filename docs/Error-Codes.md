...
이 문서는 API Gateway의 공통 오류 응답 계약을 고정한다.

## Response Envelope

Gateway가 직접 반환하는 오류 응답은 아래 JSON 구조를 사용한다.
...
운영 계약의 최종 기준은 코드의 [ErrorCode.java](/Users/jhons/Downloads/BE/Api-gateway-server/src/main/java/com/gateway/code/ErrorCode.java) 이다.
