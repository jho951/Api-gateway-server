 ...
 * </p>
 */
public final class RedisAuthzCache {
     ...
     * @param keyPrefix
     */
    public RedisAuthzCache(boolean enabled, String host, int port, String password, int timeoutMs, int ttlSeconds, String keyPrefix) {
